...
// newTestMempoolStore wraps pool in a real internal/mempool.Store — mirrors
// internal/api/mempool_fixtures_test.go's helper of the same name.
...
// pool — mirrors internal/api's helper of the same name.
