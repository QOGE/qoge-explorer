...
// fakeHash/p2pkhScript/coinbaseTx/spendTx/block mirror internal/api's
// fixtures_test.go exactly — duplicated per-package on purpose (see
// dbtest_test.go's note).
